...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
         ...
         **/
        templates: {
            actionButton: "<button class=\"btn btn-info\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",
...
//FIX
jQuery.fn.bootgrid.Constructor.defaults.labels = {
    all: "全部",
...
//FIX TODO 将服务器返回的数据进行格式转换
jQuery.fn.bootgrid.Constructor.defaults.responseHandler = function ( response ) {
