...
S2.define('select2/defaults',[
  ...
  Defaults.prototype.reset = function () {
    ...
    //FIX 修改模板
    this.defaults.templateResult = function formatState (state) {
        return $( "<span>" + state.text + "<span class='hidden'>"+ state.text + state.spell +"</span></span>" );
    };
    //FIX 匹配
    this.defaults.matcher = oldMatcher( function matchByTextAndSpell( term, text, data ) {
        var str;
        term = term.toLowerCase();
        str = ( data.text + data.spell || "" ).toLowerCase();
